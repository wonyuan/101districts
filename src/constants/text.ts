...
export const geminiPrompt = 'Generate a travel plan/itinerary for a location, {locationName} for {totalDays} days for {travelParty} with a {travelBudget} budget. Give me a hotel option list of at least 4 hotels, including the hotel name, address, price, an emoji of the hotel, geo coordinates, rating, and description and plan an itinerary for the location {locationName} for {totalDays} days including the place name, place detail, a single emoji representing the activity or place, geo coordinates, ticket pricing, rating, and time range (e.g 9:00AM - 11:30AM) for when the party should start and end the activity with the day planned from 9:00AM to 9:00PM, and time to travel to the activity for the {totalDays} days with each day planned in terms of the best time to visit, all and only in JSON format.'